...
class Board:
    ...
    def is_piece_in_the_middle(self, row, col):
    ...
    def move(self, piece, row, col):
        ...
        # check if the piece become a king
    ...
    def get_valid_moves(self, piece):
        ...
        if piece.color == RED or piece.king:
            moves.update(self._travers_left(
                row - 1, max(row - 3, -1), -1, piece.color, left))
            moves.update(self._travers_right(
